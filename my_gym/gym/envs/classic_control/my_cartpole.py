...
if __name__ == '__main__':
    ...
    env_id = "My-CartPole-v0"   # My-CartPole-v0
    num_cpu = 1
    ...
    model.save("/media/data/3D/projets/balance/weights/acktr_blender_" + str(n))


"""
    # #del model # remove to demonstrate saving and loading
    # #model = ACKTR.load("/media/data/3D/projets/balance//weights/acktr_blender_" + str(n))
