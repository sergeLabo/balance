...
def get_display(spec):
    ...
    if spec is None:
        ...
        a = 'Invalid display specification: {}. (Must be a string like :0 or None.)'
        raise error.Error(a.format(spec))
...
class Image(Geom):
    def __init__(self, fname, width, height):
        ...
        self.flip = False
    def render1(self):
        self.img.blit(-self.width/2, -self.height/2, width=self.width,
                        height=self.height)
...
class SimpleImageViewer(object):
    ...
    def imshow(self, arr):
        if self.window is None:
            ...
            self.window = get_window(width=width, height=height,
